namespace FinalADS.Application.Clientes.Constants
{
    public static class ClienteAppConstants
    {
        public const string ClienteCreado = "Mario 10 centimos de compromiso";
